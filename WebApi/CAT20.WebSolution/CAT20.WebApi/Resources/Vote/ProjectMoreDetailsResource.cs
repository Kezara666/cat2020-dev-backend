...
{
    public partial class ProjectMoreDetailsResource
    {
        ...
        public int? ProgrammeNameSinhala { get; set; }
        public int? ProgrammeNameEnglish { get; set; }
        public int? ProgrammeNameTamil { get; set; }
