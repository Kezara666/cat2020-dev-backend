...
{
    public partial class VoteDetailFullResource
    {
        ...
        public int? VoteIncomeAllocationId { get; set; }
        public int? SubLedgerId { get; set; }


        /*linking property from vote Assignment */

        public int? AccountId { get; set; }

        public VoteAssignmentBasicResource? VoteAssignment { get; set; }
    }
}