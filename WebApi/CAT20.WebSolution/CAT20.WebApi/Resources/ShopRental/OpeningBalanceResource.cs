...
{
    public partial class OpeningBalanceResource
    {
        ...
        //mapping--------------------------------------
        public virtual PropertyResource? Property { get; set; } //Mapping 1(Property): many (OpeningBalance)
        public virtual ShopResource? Shop { get; set; }  //Mapping 1(Shop): 1 (OpeningBalance)
        //---------------------------------------------
