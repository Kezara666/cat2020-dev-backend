...
{
    public class VoteBalanceTotalCreditDebitResolver : IValueResolver<VoteBalance, VoteBalanceResource, decimal>
    {
        public decimal Resolve(VoteBalance source, VoteBalanceResource destination, decimal destMember, ResolutionContext context)
        {
            ...
            */
            ...
            {
                return source.Debit - source.Credit; // Reverse calculation when classification is 2
            }
            ...
            else if (source.ClassificationId == 5)
            {
                return source.Credit - source.Debit; // Reverse calculation when classification is 4
            }
            else
            {
