...
namespace CAT20.WebApi.Mapping.MappingReslover
{
    ...
    public class VotePreBalanceResolver : IValueResolver<VoteBalance, VoteBalanceResource, decimal>
    {
...
*/
            ...
            {
                return (decimal)source.AllocationAmount! + source.Credit - source.Debit - source.TakeHoldAmount - source.TotalHold-source.TotalPending - source.TotalCommitted; // Reverse calculation when classification is 2
            }
