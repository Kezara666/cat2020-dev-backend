...
namespace CAT20.Data.OnlinePaymentDb
{
    ...
    [Migration("20241029094745_AddStartEndDatesToEachBooking")]
    partial class AddStartEndDatesToEachBooking
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CAT20.Core.Models.OnlienePayment.BookingDate", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("BookingStatus")
                        .HasColumnType("int")
                        .HasColumnName("booking_dates_booking_status");
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        ...
                        .HasColumnName("booking_dates_created_at")
                        .HasDefaultValueSql("CURRENT_TIMESTAMP");

                    b.Property<int?>("CreatedBy")
                        .HasColumnType("int")
                        .HasColumnName("booking_dates_created_by");

                    b.Property<string>("EndDate")
                        .IsRequired()
                        .HasColumnType("longtext")
                        .HasColumnName("booking_dates_end_date");

                    b.Property<int>("OnlineBookingId")
                        .HasColumnType("int")
                        .HasColumnName("booking_dates_online_booking_id");

                    b.Property<int?>("PropertyId")
                        .IsRequired()
                        .HasColumnType("int")
                        .HasColumnName("booking_dates_property_id");

                    b.Property<string>("StartDate")
                        .IsRequired()
                        .HasColumnType("longtext")
                        .HasColumnName("booking_dates_start_date");

                    b.Property<int>("SubPropertyId")
                        .HasColumnType("int")
                        .HasColumnName("booking_dates_sub_property_id");

                    b.Property<DateTime?>("UpdatedAt")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime")
                        .HasColumnName("booking_dates_updated_at");

                    b.Property<int?>("UpdatedBy")
                        .HasColumnType("int")
                        .HasColumnName("booking_dates_updated_by");
                    ...
                    b.ToTable("booking_date", (string)null);
                });
            ...
            modelBuilder.Entity("CAT20.Core.Models.OnlienePayment.OnlineBooking", b =>
                {
                    ...
                    b.Property<string>("CreationDate")
                        .IsRequired()
                        .HasColumnType("longtext")
                        .HasColumnName("online_booking_creation_date");
            ...
            modelBuilder.Entity("CAT20.Core.Models.OnlienePayment.BookingDate", b =>
                {
                    b.HasOne("CAT20.Core.Models.OnlienePayment.OnlineBooking", "OnlineBooking")
                        .WithMany()
                        .HasForeignKey("OnlineBookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CAT20.Core.Models.OnlienePayment.BookingProperty", "Property")
                        .WithMany()
                        .HasForeignKey("PropertyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CAT20.Core.Models.OnlienePayment.BookingSubProperty", "SubProperty")
                        .WithMany()
