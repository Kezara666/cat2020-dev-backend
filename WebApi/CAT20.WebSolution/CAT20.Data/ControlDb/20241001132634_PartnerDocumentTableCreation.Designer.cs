...
namespace CAT20.Data.ControlDb
{
    ...
    [Migration("20241001132634_PartnerDocumentTableCreation")]
    partial class PartnerDocumentTableCreation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CAT20.Core.Models.Control.Agents", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("cd_agent_id");

                    b.Property<string>("AgentCode")
                        .HasColumnType("longtext")
                        .HasColumnName("cd_agent_code");

                    b.Property<string>("BankAccountNumber")
                        .HasColumnType("longtext")
                        .HasColumnName("cd_agent_bank_account");

                    b.Property<int?>("BranchId")
                        .HasColumnType("int")
                        .HasColumnName("cd_agent_branch_id");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("cd_agent_create_at");

                    b.Property<int>("CreatedBy")
                        .HasColumnType("int")
                        .HasColumnName("cd_agent_create_by");

                    b.Property<string>("Reference")
                        .HasColumnType("longtext")
                        .HasColumnName("cd_agent_reference");

                    b.Property<DateTime>("RowVersion")
                        .IsConcurrencyToken()
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("timestamp(6)")
                        .HasColumnName("cd_agent_row_version");

                    b.Property<int>("SabhaId")
                        .HasColumnType("int")
                        .HasColumnName("cd_agent_sabha_id");

                    b.Property<int>("Status")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(1)
                        .HasColumnName("cd_agent_status");

                    b.Property<DateTime>("SystemActionAt")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("cd_agent_system_at");

                    b.Property<DateTime>("UpdatedAt")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("cd_agent_update_at");

                    b.Property<int>("UpdatedBy")
                        .HasColumnType("int")
                        .HasColumnName("cd_agent_update_by");
                    ...
                    b.ToTable("cd_agents", (string)null);
            ...
            modelBuilder.Entity("CAT20.Core.Models.Control.PartnerDocument", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CAT20.Core.Models.Control.Sabha", b =>
                {
                    ...
                    b.Property<int?>("ChartOfAccountVersionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("cd_s_chart_of_acc_version_id")
                        .HasDefaultValueSql("'0'");
            ...
            modelBuilder.Entity("CAT20.Core.Models.Control.Agents", b =>
                {
                    b.HasOne("CAT20.Core.Models.Control.BankBranch", "BankBranch")
                        .WithMany("Agents")
