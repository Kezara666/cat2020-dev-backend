...
namespace CAT20.Data.MixinDb
{
    ...
    [Migration("20240919090130_FirstMigV18")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CAT20.Core.Models.Mixin.MixinOrderLineLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("MixinOrderLogId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MixinOrderLogId");

                    b.HasIndex(new[] { "MixinVoteAssignmentDetailId" }, "mixin_order_line_log_FK_4");

                    b.ToTable("mixin_order_line_log", (string)null);
                });

            modelBuilder.Entity("CAT20.Core.Models.Mixin.MixinOrderLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "GnDivisionId" }, "mixin_order_log_FK_1");

                    b.HasIndex(new[] { "SessionId" }, "mixin_order_log_FK_2");

                    b.HasIndex(new[] { "PartnerId" }, "mixin_order_log_FK_3");

                    b.HasIndex(new[] { "PaymentMethodId" }, "mixin_order_log_FK_4");

                    b.ToTable("mixin_order_log", (string)null);
                });
            ...
            modelBuilder.Entity("CAT20.Core.Models.Mixin.MixinOrderLineLog", b =>
                {
                    b.HasOne("CAT20.Core.Models.Mixin.MixinOrderLog", null)
                        .WithMany("MixinOrderLineLog")
                        .HasForeignKey("MixinOrderLogId");
                });
            ...
            modelBuilder.Entity("CAT20.Core.Models.Mixin.MixinOrderLog", b =>
                {
                    b.Navigation("MixinOrderLineLog");
                });
