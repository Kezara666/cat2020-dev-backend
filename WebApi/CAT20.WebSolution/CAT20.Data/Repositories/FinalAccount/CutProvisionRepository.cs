...
{
    public class CutProvisionRepository : Repository<CutProvision>, ICutProvisionRepository
    {
        public CutProvisionRepository(DbContext context) : base(context)
        {
        }

        public async Task<(int totalCount, IEnumerable<CutProvision> list)> GetAllCutProvisionSabha(int sabhaId, int pageNo, int pageSize, string? filterKeyWord)
        {
        ...
        public async Task<(int totalCount, IEnumerable<CutProvision> list)> GetCutProvisionForApproval(int sabhaId, int pageNo, int pageSize, string? filterKeyWord)
        {
            if (filterKeyWord != "undefined")
            {
                filterKeyWord = "%" + filterKeyWord + "%";
