...
namespace CAT20.Data.ShopRentalDb
{
    ...
    [Migration("20240525034902_ShopRentalRecievableIncomeVoteTableMig")]
    partial class ShopRentalRecievableIncomeVoteTableMig
    {
            ...
            modelBuilder.Entity("CAT20.Core.Models.ShopRental.ShopRentalBalance", b =>
                {
                    ...
                    b.Property<decimal?>("TYLYOverpayment")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("sr_bal_ty_ly_overpayment")
                        .HasDefaultValueSql("'0'");
            ...
            modelBuilder.Entity("CAT20.Core.Models.ShopRental.ShopRentalProcess", b =>
                {
                    ...
                    b.Property<int>("LastSessionDay")
                        .HasColumnType("int")
                        .HasColumnName("sr_process_last_session_day");

                    b.Property<int>("LastSessionMonth")
                        .HasColumnType("int")
                        .HasColumnName("sr_process_last_session_month");

                    b.Property<int>("Month")
                        .HasColumnType("int")
                        .HasColumnName("sr_process_month");
                    ...
                    b.Property<int?>("ProcessConfigSettingAssignId")
                        .HasColumnType("int")
                        .HasColumnName("sr_process_config_assign_id");
            ...
            modelBuilder.Entity("CAT20.Core.Models.ShopRental.ShopRentalRecievableIncomeVoteAssign", b =>
                {
                    ...
                    b.Property<int>("LastYearArreasAmountVoteId")
                        .HasColumnType("int")
                        .HasColumnName("sr_ri_vote_last_year_arreas_amount_id");

                    b.Property<int>("LastYearFineAmountVoteId")
                        .HasColumnType("int")
                        .HasColumnName("sr_ri_vote_last_year_fine_id");
                    ...
                    b.Property<int>("OverPaymentAmountVoteId")
                        .HasColumnType("int")
                        .HasColumnName("sr_ri_vote_over_payment_id");
                    ...
                    b.Property<int>("PropertyRentalVoteId")
                        .HasColumnType("int")
                        .HasColumnName("sr_ri_vote_property_rental_id");
                    ...
                    b.Property<int>("ServiceChargeAmountVoteId")
                        .HasColumnType("int")
                        .HasColumnName("sr_ri_vote_service_charge_id");

                    b.Property<int>("ServiceChargeArreasAmountVoteId")
                        .HasColumnType("int")
                        .HasColumnName("sr_ri_vote_service_charge_arreas_amount_id");
                    ...
                    b.Property<int>("ThisYearArrearsAmountVoteId")
                        .HasColumnType("int")
                        .HasColumnName("sr_ri_vote_this_year_arreas_amount_id");

                    b.Property<int>("ThisYearFineAmountVoteId")
                        .HasColumnType("int")
                        .HasColumnName("sr_ri_vote_this_year_fine_id");
