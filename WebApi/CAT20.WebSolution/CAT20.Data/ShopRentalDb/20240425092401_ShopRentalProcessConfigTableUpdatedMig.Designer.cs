...
namespace CAT20.Data.ShopRentalDb
{
    ...
    [Migration("20240425092401_ShopRentalProcessConfigTableUpdatedMig")]
    partial class ShopRentalProcessConfigTableUpdatedMig
    {
            ...
            modelBuilder.Entity("CAT20.Core.Models.ShopRental.ShopRentalProcessConfigaration", b =>
                {
                    ...
                    b.Property<bool?>("FineCalType")
                        .IsRequired()
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("sr_processConfig_fine_cal_type");
                    ...
                    b.Property<int?>("FineRateType")
                        .IsRequired()
                        .HasColumnType("int")
                        .HasColumnName("sr_processConfig_fine_rate_type");

                    b.Property<bool?>("RentalPaymentDateType")
                        .IsRequired()
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("sr_processConfig_rental_payment_date_type");
                    ...
                    b.HasIndex("SabhaId", "FineRateType", "FineDailyRate", "FineMonthlyRate", "Fine1stMonthRate", "Fine2ndMonthRate", "Fine3rdMonthRate", "FineCalType", "RentalPaymentDateType")
                        .IsUnique();
