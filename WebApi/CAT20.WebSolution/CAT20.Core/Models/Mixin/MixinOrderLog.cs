...
{
    public partial class MixinOrderLog
    {
        public MixinOrderLog()
        {
            MixinOrderLineLog = new HashSet<MixinOrderLineLog>();
        }
        ...
        [JsonIgnore]
        public virtual ICollection<MixinOrderLineLog> MixinOrderLineLog { get; set; }
